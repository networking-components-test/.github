# .github
Organization-wide GitHub defaults and governance for networking-components-test


<!-- ore-org-baseline:begin -->
## Organization-wide defaults

This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`networking-components-test`](https://github.com/networking-components-test).

## Canonical organization links

- GitHub organization: https://github.com/networking-components-test
- Public organization defaults: https://github.com/networking-components-test/.github
